...
dual_port_ram #(.RAMSIZEWIDTH(`rRAMSIZEWIDTH), .RAMWIDTH(`RAMWIDTH)) inst1( 
.clk (clk),
.we1(wren),
.we2(1'b0),
.data1(data),
...
module top_ram (
 ...
 dual_port_ram #(.RAMSIZEWIDTH(`rRAMSIZEWIDTH), .RAMWIDTH(`RAMWIDTH)) inst2(
 .clk (clk),
 .we1(wren),
 .we2(1'b0),
 .data1(data),
...
// Write but no read.
  ...
  dual_port_ram #(.RAMSIZEWIDTH(`rRAMSIZEWIDTH), .RAMWIDTH(`RAMWIDTH)) ram_addr(
